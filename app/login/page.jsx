            ...
            <div className="relative z-10 w-full max-w-sm animate-fade-in px-4">
                ...
                <div className="text-center mb-8 animate-slide-up">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-600/10 border border-blue-500/20 mb-4 shadow-sm">
                        <Container className="w-8 h-8 text-blue-500 dark:text-blue-400" />
                    </div>
                    <h1 className="text-2xl font-bold text-foreground tracking-tight">Docklab</h1>
                    <p className="text-sm text-muted-foreground mt-1">Docker Management Platform</p>
                </div>
